...
/* --- カスタムタクソノミー複製の場合はここから --- */
/* ---------- カスタムタクソノミー [実績ジャンル] を作成 ---------- */
function create_custom_taxonomy_works_genre() {
	register_taxonomy(
		'works_genre',
		'works',
		array(
			'labels' => array(
				'name' => '実績ジャンル',
				'singular_name' => '実績ジャンル',
				'search_items' => '実績ジャンル検索',
				'all_items' => '全ての実績ジャンル',
				'parent_item' => '親の実績ジャンル',
				'parent_item_colon' => '親の実績ジャンル:',
				'edit_item' => '実績ジャンルを編集',
				'update_item' => '実績ジャンルを更新',
				'add_new_item' => '実績ジャンル追加',
				'new_item_name' => '新しい実績ジャンル',
				'menu_name' => '実績ジャンル',
			),
			'public' => true,
			'show_ui' => true,
...
add_action('init', 'create_custom_taxonomy_works_genre');
/* --- カスタムタクソノミー複製の場合はここまでをコピーして使う --- */
