		...
		<div class="l-header__inner">
			...
			<nav class="l-header__nav">
				<ul class="l-header__navList">
					<li class="l-header__navItem"><a href="<?php echo HOME_URL; ?>" class="l-header__navLink" title="ホームに移動する">ホーム</a></li>
					...
					<li class="l-header__navItem"><a href="<?php echo SERVICES_URL; ?>" class="l-header__navLink" title="事業内容に移動する">事業内容</a></li>
					...
					<li class="l-header__navItem"><a href="<?php echo ITEMS_URL; ?>" class="l-header__navLink" title="商品紹介に移動する">商品紹介</a></li>
