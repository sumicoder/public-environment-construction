...
define('WORKS_CATEGORY_URL', esc_url(home_url('/works_category/'))); // 実績カテゴリー
define('TOPICS_CATEGORY_URL', esc_url(home_url('/topics_category/'))); // トピックスカテゴリー
define('CONTACT_URL', esc_url(home_url('/contact/'))); // お問い合わせ
define('RECRUIT_URL', esc_url(home_url('/recruit/'))); // 採用情報
define('PRODUCTS_URL', esc_url(home_url('/products/'))); // 商品紹介
define('PRODUCTS_GENRE_URL', esc_url(home_url('/products_genre/'))); // 商品ジャンル
define('PRODUCTS_COLOR_URL', esc_url(home_url('/products_color/'))); // 商品カラー
define('THANKS_URL', esc_url(home_url('/thanks/'))); // お問い合わせ

/* ---------- 外部リンク ---------- */
define('SNS_X',  'https://www.x.com'); // X
define('GOOGLE_MAP',  'https://google.map'); // Google Map
define('LINE',  'https://line.com'); // LINE
